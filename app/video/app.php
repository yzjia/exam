...
class app
{
	...
	public function register()
	{
		if($this->ev->get('userregister'))
		{
			...
			$usercellphone = $args['usercellphone'];
			$id = $this->user->insertUser(array('username' => $username,'usergroupid' => $defaultgroup['groupid'],'userpassword' => md5($args['userpassword']),'useremail' => $email,'usercellphone' => $usercellphone));
