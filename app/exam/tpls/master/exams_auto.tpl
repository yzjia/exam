	        ...
	        <form action="?exam-master-exams-autopage" method="post" class="form-horizontal">
				...
				<div class="control-group">
					<label class="control-label" for="content">考试科目：</label>
				  	<div class="controls">
					  	<select class="combox" needle="needle" min="1" name="args[examsubject]" onchange="javascript:$('#examrulesbox').loadUrl('?exam-master-exams-ajax&subjectid='+$(this).find('option:selected').val());">
