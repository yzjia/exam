			...
			<form class="examform form-horizontal" id="form1" name="form1" action="index.php?exam-app-exam-makescore">
                ...
                <div>
                	...
                	<div class="span8">
                       ...
                       <div class="text-center"><a href="index.php?exam-app-exam-view" class="btn btn-info">查看答案和解析</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?exam-app-history&ehtype=2" class="btn btn-info">进入我的考试记录</a></div>
                	</div>
                </div>
			</div>
		</div>
