                ...
                <div>
                	...
                	<div class="span8">
                		<div><b class="text-info">考试详情：</b></div>
              			<p>总分：<b class="text-warning">{x2;$sessionvars['examsessionsetting']['examsetting']['score']}</b>分 合格分数线：<b class="text-warning">{x2;$sessionvars['examsessionsetting']['examsetting']['passscore']}</b>分 答卷耗时：<b class="text-warning">{x2;$sessionvars['examsessiontime']}</b>分钟</p>
                       ...
                       <div class="text-center"><a href="index.php?exam-app-exampaper-view" class="btn btn-info">查看答案和解析</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?exam-app-history&ehtype=1" class="btn btn-info">进入我的考试记录</a></div>
                	</div>
                </div>
			</div>
		</div>
